...
<?= $this->section('title') ?>Edit Visi & Misi<?= $this->endSection() ?>
...
<div class="admin-page-header mb-4">
    <nav aria-label="breadcrumb" class="mb-2">
        <ol class="breadcrumb small mb-0">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('admin/konten/visi-misi') ?>">Visi &amp; Misi</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit</li>
        </ol>
    </nav>
    <h1 class="h3 fw-bold text-body mb-1">Edit Konten Visi &amp; Misi</h1>
    <p class="text-secondary mb-0">
        Ubah judul, deskripsi, dan isi konten Visi &amp; Misi.
    </p>
</div>
...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-4 p-lg-5">
        <form method="post" action="<?= base_url('admin/konten/visi-misi/update') ?>" novalidate>
            <?= csrf_field() ?>
            ...
            <div class="mb-4">
                <label for="body" class="form-label fw-semibold">Isi visi dan misi</label>
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a class="btn btn-outline-secondary rounded-3" href="<?= base_url('admin/konten/visi-misi') ?>">
                    Kembali
                </a>
                <a class="btn btn-outline-secondary rounded-3" href="<?= base_url('profil/visi-misi') ?>" target="_blank" rel="noopener noreferrer">
