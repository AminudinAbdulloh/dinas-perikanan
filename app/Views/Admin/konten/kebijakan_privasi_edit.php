...
<?= $this->section('title') ?>Edit Kebijakan Privasi<?= $this->endSection() ?>
...
<div class="admin-page-header mb-4">
    <nav aria-label="breadcrumb" class="mb-2">
        <ol class="breadcrumb small mb-0">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('admin/konten/kebijakan-privasi') ?>">Kebijakan Privasi</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit</li>
        </ol>
    </nav>
    <h1 class="h3 fw-bold text-body mb-1">Edit Kebijakan Privasi</h1>
    <p class="text-secondary mb-0">
        Ubah isi konten kebijakan privasi.
    </p>
</div>
...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-4 p-lg-5">
        <form method="post" action="<?= base_url('admin/konten/kebijakan-privasi/update') ?>" novalidate>
            <?= csrf_field() ?>

            <div class="mb-4">
                <label for="content" class="form-label fw-semibold">Isi Kebijakan Privasi</label>
                <textarea class="form-control rounded-3 admin-richtext-source" id="content" name="content" rows="14"><?= old('content', $policy['content'] ?? '', false) ?></textarea>
                <div class="form-text">
                    Tuliskan kebijakan privasi dengan jelas.
                </div>
            </div>
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a class="btn btn-outline-secondary rounded-3" href="<?= base_url('admin/konten/kebijakan-privasi') ?>">
                    Kembali
                </a>
...
<script>
(function () {
    const form = document.querySelector('form[action*="konten/kebijakan-privasi/update"]');
    if (!form) return;
