...
<?= $this->section('title') ?>Konten Daftar Pegawai<?= $this->endSection() ?>
...
<div class="admin-page-header mb-4">
    ...
    <h1 class="h3 fw-bold text-body mb-1">Konten Daftar Pegawai</h1>
    <p class="text-secondary mb-0">
        Halaman utama pengelolaan konten untuk
        <a href="<?= base_url('profil/pegawai') ?>" target="_blank" rel="noopener noreferrer">profil/pegawai</a>.
...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-body p-4 p-lg-5">
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
            <div>
                <h2 class="h5 fw-bold mb-1"><?= esc($page['title'] ?? 'Daftar Pegawai') ?></h2>
                <p class="text-secondary mb-0 small"><?= esc($page['description'] ?? '') ?></p>
            </div>
            <div class="d-flex gap-2">
                <a class="btn btn-primary rounded-3 px-4" href="<?= base_url('admin/konten/pegawai/edit') ?>">
