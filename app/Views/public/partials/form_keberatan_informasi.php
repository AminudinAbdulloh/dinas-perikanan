<div class="info-form-wrapper">
    <form class="info-form-layout" action="#" method="post" enctype="multipart/form-data">
        <div class="form-block">
            ...
            <input id="keberatan-nama" type="text" class="form-control custom-input"
        ...
        <div class="form-block">
            ...
            <div class="form-grid-2">
                ...
                <input id="keberatan-nomor-identitas" type="text" class="form-control custom-input"
        ...
        <div class="form-block">
            ...
            <textarea id="keberatan-alamat" rows="3" class="form-control custom-input"
        ...
        <div class="form-block">
            ...
            <textarea id="keberatan-kasus" rows="5" class="form-control custom-input"
        ...
        <div class="form-block">
            ...
            <input id="keberatan-registrasi" type="text" class="form-control custom-input"
                placeholder="Contoh: PPID/2026/001">
        </div>
        ...
        <div class="info-note-warning">
            <p>
                ...
                keberatan diterima. Anda akan menerima pemberitahuan mengenai status keberatan melalui email atau
                telepon.
            </p>
        </div>
