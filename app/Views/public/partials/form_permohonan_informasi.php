        ...
        <div class="tab-pane fade show active" id="panel-permohonan" role="tabpanel" aria-labelledby="tab-permohonan">
            <form class="info-form-layout" action="#" method="post">
                ...
                <div class="form-block">
                    ...
                    <input id="nama-pemohon" type="text" class="form-control custom-input"
                        placeholder="Masukkan nama lengkap">
                </div>

                <div class="form-block">
                    <label for="pekerjaan" class="form-title">Pekerjaan <span class="text-danger">*</span></label>
                    <input id="pekerjaan" type="text" class="form-control custom-input"
                        placeholder="Masukkan pekerjaan">
                </div>

                <div class="form-block">
                    <label for="alamat" class="form-title">Alamat <span class="text-danger">*</span></label>
                    <textarea id="alamat" rows="3" class="form-control custom-input"
                ...
                <div class="form-block">
                    <label for="nomor-identitas" class="form-title">No. Identitas <span
                            class="text-danger">*</span></label>
                    <input id="nomor-identitas" type="text" class="form-control custom-input"
                ...
                <div class="form-block">
                    <label for="rincian-informasi" class="form-title">Rincian Informasi Yang Dibutuhkan <span
                            class="text-danger">*</span></label>
                    <textarea id="rincian-informasi" rows="4" class="form-control custom-input"
                        placeholder="Jelaskan secara detail informasi yang Anda butuhkan"></textarea>
                </div>

                <div class="form-block">
                    <label for="tujuan-informasi" class="form-title">Tujuan Penggunaan Informasi <span
                            class="text-danger">*</span></label>
                    <textarea id="tujuan-informasi" rows="3" class="form-control custom-input"
        ...
        <div class="tab-pane fade" id="panel-lacak" role="tabpanel" aria-labelledby="tab-lacak">
            <form class="info-form-layout" action="#" method="post">
                <div class="form-block">
                    ...
                    <input id="data-lacak" type="text" class="form-control custom-input"
                        placeholder="Masukkan nomor identitas, telepon, atau email yang didaftarkan">
                    <p class="field-help-text">
                        Masukkan salah satu dari: No. KTP/SIM/Paspor, No. Telepon, atau Email yang Anda gunakan saat
