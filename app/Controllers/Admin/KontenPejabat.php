...
class KontenPejabat extends BaseController
{
    protected $helpers = ['form', 'url', 'content'];

    public function index(): string
    {
        $page = $this->resolvePejabatPage();

        return view('admin/konten/pejabat', [
            'title'       => 'Konten Profil Pejabat Struktural',
            'adminNav'    => 'konten-pejabat',
            'page'        => $page,
    ...
    public function edit(): string
    {
        ...
        return view('admin/konten/pejabat_edit', [
            'title'    => 'Edit Profil Pejabat Struktural',
            'adminNav' => 'konten-pejabat',
            'page'     => $page,
        ]);
    }
    ...
    public function update(): ResponseInterface
    {
        ...
        $slug = SitePageModel::SLUG_PROFIL_PEJABAT;
        ...
        return redirect()->to(base_url('admin/konten/pejabat'))->with('message', 'Halaman Profil Pejabat Struktural berhasil disimpan.');
    }

    /**
     * @return array<string, mixed>
     */
    private function resolvePejabatPage(): array
    {
        $slug = SitePageModel::SLUG_PROFIL_PEJABAT;
        ...
        $public = $beranda->getPublicPageData('profil/pejabat');

        return [
            'title'       => $public['title'] ?? 'Profil Pejabat Struktural',
