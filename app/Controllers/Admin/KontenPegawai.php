...
class KontenPegawai extends BaseController
{
    protected $helpers = ['form', 'url', 'content'];

    public function index(): string
    {
        $page = $this->resolvePegawaiPage();

        return view('admin/konten/pegawai', [
            'title'       => 'Konten Daftar Pegawai',
            'adminNav'    => 'konten-pegawai',
            'page'        => $page,
    ...
    public function edit(): string
    {
        ...
        return view('admin/konten/pegawai_edit', [
            'title'    => 'Edit Daftar Pegawai',
            'adminNav' => 'konten-pegawai',
            'page'     => $page,
        ]);
    }
    ...
    public function update(): ResponseInterface
    {
        ...
        $slug = SitePageModel::SLUG_PROFIL_PEGAWAI;
        ...
        return redirect()->to(base_url('admin/konten/pegawai'))->with('message', 'Halaman Daftar Pegawai berhasil disimpan.');
    }

    /**
     * @return array<string, mixed>
     */
    private function resolvePegawaiPage(): array
    {
        $slug = SitePageModel::SLUG_PROFIL_PEGAWAI;
        ...
        $public = $beranda->getPublicPageData('profil/pegawai');

        return [
            'title'       => $public['title'] ?? 'Daftar Pegawai',
