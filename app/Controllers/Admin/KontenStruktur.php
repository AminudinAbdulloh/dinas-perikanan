...
class KontenStruktur extends BaseController
{
    protected $helpers = ['form', 'url', 'content'];

    public function index(): string
    {
        $page = $this->resolveStrukturPage();

        return view('admin/konten/struktur', [
            'title'       => 'Konten Struktur Organisasi',
            'adminNav'    => 'konten-struktur',
            'page'        => $page,
    ...
    public function edit(): string
    {
        ...
        return view('admin/konten/struktur_edit', [
    ...
    public function update(): ResponseInterface
    {
        ...
        $slug = SitePageModel::SLUG_PROFIL_STRUKTUR;
        ...
        return redirect()->to(base_url('admin/konten/struktur'))->with('message', 'Halaman Struktur Organisasi berhasil disimpan.');
    }

    /**
     * @return array<string, mixed>
     */
    private function resolveStrukturPage(): array
    {
        $slug = SitePageModel::SLUG_PROFIL_STRUKTUR;
        ...
        $public = $beranda->getPublicPageData('profil/struktur');

        return [
            'title'       => $public['title'] ?? 'Struktur Organisasi',
